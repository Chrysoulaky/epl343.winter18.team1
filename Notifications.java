...
public class Notifications extends JFrame {
	...
	public Notifications() {
		...
		String[] array = { "Marios Kyriakou", "Andreas Petrou", "Andri Andreou", "Maria Stylianou", "Petros Petrou",
				"Constantinos Constantinou", "Nicolas Nicolaou", "Alexandros Melas", "Tony Demetriou", "Anna Razi" };
		...
		String[] array1 = { "Amalia Petrou", "Andreas Kyriakou", "Leda Stylianou", "Maria Constantinou",
				"Constantinos Nicolaou", "Nicolas Damianou", "Elena Andreou", "Marios Alexandrou", "Tony Demetriou",
				"Anna Razi" };
